...
function CountryRoutes(props) {
    return(<div>
        ...
        <Route exact path="/France" render={() => 
          <FranceContainer url={props.url} name="France" Authenticate = {props.Authenticate} isAuthenticated = {props.isAuthenticated} handleMenu = {props.handleMenu} getMenuState = {props.getMenuState}/>
        }/>
        <Route exact path="/IceLand" render={() => 
          <IceLandContainer url={props.url} name="IceLand" Authenticate = {props.Authenticate} isAuthenticated = {props.isAuthenticated} handleMenu = {props.handleMenu} getMenuState = {props.getMenuState}/>
        }/>
